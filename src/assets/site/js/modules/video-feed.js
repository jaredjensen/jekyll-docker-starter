(function ($) {
	...
	function buildFeed() {
		...
		var url = 'https://www.googleapis.com/youtube/v3/search?part=id&forMine=true&order=date&type=video&key=AIzaSyA6-lj3O_SU2zKV4GmM_aZuNbCfvNqtyYM&maxResults=' + numVideos;
